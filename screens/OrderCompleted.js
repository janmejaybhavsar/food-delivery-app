  ...
  return (
    <SafeAreaView style={{flex:1, backgroundColor:"white"}}>
        <View style={{margin:15, alignItems:"center", height:"100%"}}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{height:"50%", marginVertical:20}}>
                <MenuItem restaurantName={restaurantName} foods={lastOrder.items} hideCheckbox={true} marginLeft={10} />
